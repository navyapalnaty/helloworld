...
app.get("/bookProperty",function(req,res){
    bag={};
    bag.userId = req.query.userId;
    bag.propertyId=req.query.propertyId;
    console.log(bag , "bag");
    async.series([
...
app.get('/reservedproperty', function (req, res) {

    bag={};
    bag.userId = req.query.userId;
    bag.propertyId=req.query.property_id;
    console.log(bag)
    async.series([
...
app.get('/cancelProperty', function (req, res) {
...
app.get("/buyerreservedproperty" , function (req, res) {
...
app.get("/sellerViewProperty" , function (req, res) {
    var id=req.query.userId;
    console.log(id ,"id");
...
app.get("/buyerhistory" , function (req, res) {
    var id=req.query.userId;
    console.log(id ,"id");
    connectionFrom.connVar.query('select * from  booking where  buyerId  = ' + connectionFrom.connVar.escape(id)    ,
        function (err, rows, fields) {
            if(!err)
            {
                if(rows.length >0)
...
app.get("/sellerhistory" , function (req, res) {
    var id=req.query.userId;
    console.log(id ,"id");
    connectionFrom.connVar.query('select * from  booking where  sellerId  = ' + connectionFrom.connVar.escape(id)    ,
        function (err, rows, fields) {
            if(!err)
            {if(rows.length >0)
            {
...
app.post("/seehistory" , function (req, res) {
    connectionFrom.connVar.query('select * from  booking '   ,
        function (err, rows, fields) {
            if(!err)
            {
                console.log(rows);
