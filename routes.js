...
angular.module('myModule', ['ui.router' , 'ngFileUpload' ])
    ...
    .config(function($stateProvider,  $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('contact', {
                url: '/contact',
                templateUrl: source + '/templates/contact.html',
            ...
            .state('history', {
                url: '/history',
                templateUrl: source + '/templates/history.html',
            ...
            .state('buyerhistory', {
                url: '/buyerhistory',
                templateUrl: source + '/templates/history.html',
                controller: 'buyerhistoryCtrl'
            })

            .state('sellerhistory', {
                url: '/sellerhistory',
                templateUrl: source + '/templates/history.html',
                controller: 'sellerhistoryCtrl'
            })
    ...
    .controller('buyerCtrl', function ($scope,$state,$stateParams, $http) {
        ...
        $scope.bookedproperty= function () {
            $state.go('buyerhistory');
        }
...
/*.controller('MyCtrl', ['$scope', 'Upload', function ($scope, Upload) {
   ...
   /!* $scope.uploadFiles = function (files) {
    ...
    .controller('historyCtrl', function ($scope,$state, $http) {
        ...
        $http.post('/seehistory').success(function (response) {
            console.log(response, "response");
            $scope.result = response;
        });
    })

    .controller('buyerhistoryCtrl', function ($scope,$state,$stateParams, $http) {

        var userId = localStorage.getItem('ppid');
        data = {"userId": userId}
        console.log('i am inside controller ')

        $http.post('/buyerhistory', data).success(function (response) {
            console.log(response, "response");
            $scope.result = response;
        });
    })

    .controller('sellerhistoryCtrl', function ($scope,$state,$stateParams, $http) {

        var userId = localStorage.getItem('ppid');
        data = {"userId": userId}
        console.log('i am inside controller ')

        $http.post('/sellerhistory', data).success(function (response) {
            console.log(response, "response");
            $scope.result = response;
        });
    })
